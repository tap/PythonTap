...
// C-style trampolines registered on the Max object for the attributes and
...
namespace tap::python {
    ...
    c74::max::t_max_err python_mess_gimme(c74::max::t_object* x, c74::max::t_symbol* name, long ac,
                                          c74::max::t_atom* av);

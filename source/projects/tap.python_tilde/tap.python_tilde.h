...
class python : public object<python>, public vector_operator<> {
  public:
    // The reference page (docs/tap.python~.maxref.xml) is generated by min from these descriptions
    // whenever the external is newer than it, so this is where the documentation lives. Write no
    // angle brackets: min copies the text into the XML unescaped.
    MIN_DESCRIPTION{"Process audio with a Python class. The argument names a file in the package's python folder, "
                    "which must define a class of the same name. The class's type-annotated public fields become "
                    "attributes (int, float, bool and str; Optional allowed), and its public methods become "
    ...
    argument<symbol> m_source_arg{
        this, "source",
        "Python class file. The name of a .py file in the package's python folder, without the "
